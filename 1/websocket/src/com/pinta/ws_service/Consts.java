...
public class Consts {
    ...
    public class WsConstant {
        ...
        public static final String WS_CALL_PARAM = "ws_call_param";
        public static final String WS_CONNECT_OPEN = "ws_connect_open";
        public static final String WS_CONNECT_CLOSE = "ws_connect_close";
        public static final String WS_TEXT_MESSAGE = "ws_text_message";
        public static final String WS_UNSUBSCRIBE = "ws_unsubscribe";
    }
